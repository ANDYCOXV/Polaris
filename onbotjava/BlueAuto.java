...
Description:
This is the Blue Autonomous for the robot for FTC robotics 2017.
This Autonomous is programmed for the X-Drive.
This Autonomous removes the red jewel and moves the robot into the safe zone.
NOTE: This Autonomous is an exact copy of the red Autonomous,
        however the directions are all reversed.
*/
...
//Exact copy of the red Autonomous, but direction is flipped.
public class BlueAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(color.red() < color.blue()) //Blue ball is front.
        {
            ...
            move(BACKWARDS); //Reposition robot to move to safe zone.
